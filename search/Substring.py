...
def run(input, domain):
    ...
    for g in domain:
        ...
        gen = position_all_intervals(input_intervals, group_intervals)
        while True:
            try:
...
def position_interval(sub_inter, super_inter):
...
def position_all_intervals(sub_inters, super_inter):
